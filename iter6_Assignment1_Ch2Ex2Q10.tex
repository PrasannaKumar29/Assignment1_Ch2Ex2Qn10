...
{\left\|\mathbf{A}\right\|}^2+{\left\|\mathbf{B}\right\|}^2- 2 \vec{A}.\vec{B} &= {\left\|\mathbf{A}\right\|}^2+{\left\|\mathbf{C}\right\|}^2- 2 \vec{A}.\vec{C} \\[6pt]
{\left\|\mathbf{B}\right\|}^2-{\left\|\mathbf{C}\right\|}^2 &= 2 \vec{A}.\vec{B}-2 \vec{A}.\vec{C} \\[6pt]
{\left\|\mathbf{B}\right\|}^2-{\left\|\mathbf{C}\right\|}^2 &= 2 \vec{A}. (\vec{B}-\vec{C})\\[6pt]
29-8 &= 2. \vec{A}.\myvec{4\\3}\\[6pt]
\vec{A}.\myvec{8\\6} &= 21
\end{align*}
